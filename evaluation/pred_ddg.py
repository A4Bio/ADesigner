...
ROSETTA_EXE = '/tancheng/experiments/Rosetta/rosetta_bin_linux_2021.16.61629_bundle/main/source/bin/fixbb.static.linuxgccrelease'
...
def pred_ddg(wt_pdb, mut_pdb, opt_sidechain=1, n_proc=1):
    if opt_sidechain > 0:
